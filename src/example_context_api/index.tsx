...
import { AppStoreProved, useAppStore } from './context.tsx';
...
const ThemeWrapper = ({ children }: any) => {
  ...
  return <div data-bs-theme={state.theme}>{children}</div>;
};
...
const Wrapper = ({ children }: any) => {
  ...
  const border = state.theme === 'dark' ? 'border-white' : 'border-dark';
  return (
